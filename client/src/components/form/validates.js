export default function validate(newDog){
    ...
    }else if(newDog.weight_max<newDog.weight_min){
        errors.weight_max="Weight max must be greater than the Weight min."
    }else if(newDog.weight_max>110){
        errors.weight_max="Weight max must be less than 110kgs."
    ...
    if(!newDog.height_min){
        ...
        errors.height_min="Weight min must be a number."
    ...
    if(!newDog.height_max){
        ...
        errors.height_max="Weight min must be a number."
    }else if(newDog.height_max<newDog.height_min){
    ...
    if(!newDog.life_span){
        ...
        errors.life_span="Weight min must be a number."
    }else if(newDog.life_span>20){
        errors.life_span="Dogs have an average lifespan of 20 years."
